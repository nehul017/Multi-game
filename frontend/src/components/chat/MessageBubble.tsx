  ...
  return (
    <div className={cn('flex gap-2', isMine ? 'flex-row-reverse' : 'flex-row')}>
      ...
      <div className={cn('max-w-[70%]', isMine && 'items-end')}>
        {!isMine && (
          <p className="text-xs font-medium text-gray-400 mb-1 ml-1">{message.senderUsername}</p>
        )}
        <div
          className={cn(
        ...
        <p className={cn('text-[10px] text-gray-500 mt-1', isMine ? 'text-right mr-1' : 'ml-1')}>
