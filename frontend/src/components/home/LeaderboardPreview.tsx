          ...
          {players.slice(0, 3).map((player) => {
            ...
            return (
              <li
                key={player.userId}
                className={cn(
                  'relative surface-card p-5 sm:p-6 flex flex-col gap-4',
              ...
              >
                ...
                <dl className="grid grid-cols-2 gap-3 pt-2 border-t border-theme">
                  <div>
                    ...
                    <dd className="text-sm font-semibold text-theme-primary">{formatXp(player.xp)}</dd>
                  </div>
                  <div>
                    <dt className="text-xs text-theme-muted">Wins</dt>
                    <dd className="text-sm font-semibold text-theme-primary">{player.wins}</dd>
                  </div>
                </dl>
              </li>
            );
