...
export const HOME_GAMES: HomeGame[] = [
  ...
  catalogGame({
    ...
    slug: 'poker',
    name: 'Poker Room',
    description: "Texas Hold'em, Omaha, Omaha Hi-Lo, and 5 Card Draw on a live casino table.",
    genres: ['Arcade', 'Casino', 'Multiplayer'],
    category: 'arcade',
    rating: 4.9,
    onlinePlayers: 0,
    plays: 0,
    image: GAME_ARTWORK.poker,
    artTone: 'forest',
    isNew: true,
    isTrending: true,
    isFeatured: true,
  ...
  catalogGame({
    ...
    slug: 'mindi',
    name: 'Mindi Cot',
    description: '4-player partnership card game. Capture tens with your partner across a live felt table.',
    genres: ['Strategy', 'Cards', 'Multiplayer'],
    category: 'strategy',
    rating: 4.8,
    onlinePlayers: 0,
    plays: 0,
    image: GAME_ARTWORK.mindi,
    artTone: 'violet',
    isNew: true,
    isTrending: true,
    isMultiplayer: true,
